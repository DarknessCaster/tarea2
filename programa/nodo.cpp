...
int main(int nargs, char* arg_arr[]){
    if(nargs == 4){
        ...
        printf("-------------------\n");
        printf("Para ejecutar el programa debe inicializar un nodo con su respectiva letra usando el comando:\n");
        ...
        printf("mensajes a otros nodos a través de un protocolo IP modificado. Los mensajes pueden ser unicast (a un solo nodo)\n");
